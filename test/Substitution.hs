...
subst5 :: TestTree
subst5 =
    mkVarTest (Mu "a" (Cut (Var "x") (Covar "a"))) (Var "x") "x" (Mu "a0" (Cut (Var "x") (Covar "a0")))

-- Covar tests
subst6 :: TestTree
subst6 =
    mkCovarTest
        (Mu "a0" (Cut (Var "x") (Covar "a0")))
        (Covar "b")
        "c"
        (Mu "a1" (Cut (Var "x") (Covar "a1")))
